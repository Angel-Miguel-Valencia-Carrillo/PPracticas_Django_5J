...
<head>
    ...
    <title>Registro de Productos - Valenciaga Drinks</title>
        ...
        <div class="form-container">
            ...
            <form method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="stock" name="stock" placeholder="Cantidad disponible" required>
                </div>
                <div class="form-group">
                    <label for="tipo">Tipo de Licor</label>
                    <input type="text" id="tipo" name="tipo" placeholder="Tipo de licor" required>
                </div>
                <div class="form-group">
