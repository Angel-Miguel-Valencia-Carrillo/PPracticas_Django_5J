...
<body>
  ...
  <main>
    ...
    <div class="container-fluid p-5 text-center bg-dark text-white" style="background-image: url('Imagenes/banner-licoreria.jpg'); background-size: cover; background-position: center;">
        ...
        <a href="productos.php" class="btn btn-light btn-lg">Explora Nuestros Productos</a>
    </div>

    <!-- Sección de Destacados -->
    <div class="container mt-5">
        <h2 class="text-center md-4">Nuestros Productos Destacados</h2>
        <div class="row text-center">
            <div class="col-md-4">
                <img src="images/vinot3.jpg" alt="Vino Tinto Premium" class="img-fluid rounded">
                <h3 class="text-light">Vino Tinto Reserva</h3>
            ...
            <div class="col-md-4">
                ...
                <h3 class="text-light">Whisky Escocés</h3>
                <p>El sabor clásico de un whisky escocés premium, con notas ahumadas y especiadas.</p>
            </div>
            <div class="col-md-4">
                <img src="images/cervezaA.jpg" alt="Cerveza Artesanal" class="img-fluid rounded">
                <h3 class="text-light">Cerveza Artesanal</h3>
