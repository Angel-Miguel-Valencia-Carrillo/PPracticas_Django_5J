...
<body>
  ...
  <main>
    ...
    <div class="container-fluid p-5 text-center bg-dark text-white" style="background-image: url('Imagenes/banner-licoreria.jpg'); background-size: cover; background-position: center;">
        ...
        <a href="PaginaPrincipal.php" class="btn btn-light btn-lg">Explora Nuestros Productos</a>
    </div>
    ...
    <div class="container mt-5">
        ...
        <div class="row text-center">
            <div class="col-md-4">
                <img src="../images/vinoTT.jpg" alt="Vino Tinto Premium" class="img-fluid rounded">
