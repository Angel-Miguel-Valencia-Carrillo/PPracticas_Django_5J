...
def registrarVenta(request):
    ...
    guardarVenta=Venta.objects.create(
        id_empleado=id_empleado,id_cliente=id_cliente,id_empleado=id_empleado,id_producto=id_producto,fecha_venta=fecha_venta,cant=cant,importe_pagar=importe_pagar
    ) # GUARDA EL REGISTRO
